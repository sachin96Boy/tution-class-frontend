  ...
  extraReducers(builder) {
    builder
      ...
      .addCase(registerUser.rejected, (state, action) => {
        ...
        const errorData =
          (action.payload as any)?.error || action.error.message;
      ...
      .addCase(registerCoporateUser.pending, (state, action) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(registerCoporateUser.fulfilled, (state, action) => {
        state.loading = false;
        state.error = null;
        toaster.create({
          type: "success",
      ...
      .addCase(registerCoporateUser.rejected, (state, action) => {
        state.loading = false;
        state.error = true;
      ...
      .addCase(loginCoporateUser.pending, (state, action) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(loginCoporateUser.fulfilled, (state, action) => {
        state.loading = false;
      ...
      .addCase(loginCoporateUser.rejected, (state, action) => {
        state.loading = false;
        state.error = true;
